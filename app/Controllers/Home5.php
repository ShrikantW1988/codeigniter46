...
class Home5 extends BaseController
{
    public $db, $db2;
    ...
    {        
        echo view('home5/test');        
    }
    public function test1()
    {
        echo view('layout/viho/header');
        echo view('layout/viho/sidebar');
        echo view('home5/test1');
        echo view('layout/viho/footer');
    } 
    ...
    public function form_action()
    {
        ...
        {
            unset($post['daterangepicker_start']);
            unset($post['daterangepicker_end']);
