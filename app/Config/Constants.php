...
define('BASE_URL', 'http://localhost/codeigniter46/');
define('ASSETS_URL', 'http://localhost/codeigniter46/public/limitless/assets/');
define('ASSETS_URL2', 'http://localhost/codeigniter46/public/attex/assets/');
