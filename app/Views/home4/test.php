                ...
                <div class="navbar-header">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="py-lg-2 pr-lg-2">
                                            <img src="<?=ASSETS_URL4?>images/illustrator/1.png" alt="" class="img-fluid mx-auto" style="max-height: 250px;">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block language-switch">
                            <button type="button" class="btn header-item"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img id="header-lang-img" src="<?=ASSETS_URL4?>images/flags/us.jpg" alt="Header Language" height="16">
                            </button>
                            <div class="dropdown-menu dropdown-menu-end">
                    
                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="eng">
                                    <img src="<?=ASSETS_URL4?>images/flags/us.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">English</span>
                                </a>
                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="sp">
                                    <img src="<?=ASSETS_URL4?>images/flags/spain.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">Spanish</span>
                                </a>

                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="gr">
                                    <img src="<?=ASSETS_URL4?>images/flags/germany.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">German</span>
                                </a>

                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="it">
                                    <img src="<?=ASSETS_URL4?>images/flags/italy.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">Italian</span>
                                </a>

                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ru">
                                    <img src="<?=ASSETS_URL4?>images/flags/russia.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">Russian</span>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0">
                                ...
                                <div data-simplebar style="max-height: 270px;">
                                    <a class="notification-item text-reset" href="#!">
                                        <div class="d-flex border-bottom align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="<?=ASSETS_URL4?>images/brands/slack.png" alt="slack">
                                            </div>
                                    ...
                                    <a class="notification-item text-reset" href="#!">
                                        <div class="d-flex border-bottom align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="<?=ASSETS_URL4?>images/brands/behance.png" alt="behance">
                                            </div>
                                            <div class="flex-grow-1 ms-4">
                                    ...
                                    <a class="notification-item text-reset" href="#!">
                                        <div class="d-flex border-bottom align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="<?=ASSETS_URL4?>images/brands/dribbble.png" alt="dribbble">
                                            </div>
                                            <div class="flex-grow-1 ms-4">
                                    ...
                                    <a class="notification-item text-reset" href="#!">
                                        <div class="d-flex border-bottom align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="<?=ASSETS_URL4?>images/brands/dropbox.png" alt="dropbox">
                                            </div>
                                            <div class="flex-grow-1 ms-4">
                                    ...
                                    <a class="notification-item text-reset" href="#!">
                                        <div class="d-flex border-bottom align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="<?=ASSETS_URL4?>images/brands/mail_chimp.png" alt="mail_chimp">
                                            </div>
                                            <div class="flex-grow-1 ms-4">
                                    ...
                                    <a class="notification-item text-reset" href="#!">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="<?=ASSETS_URL4?>images/brands/github.png" alt="github">
                                            </div>
                                            <div class="flex-grow-1 ms-4">
                                ...
                                <div data-simplebar style="max-height: 250px;">
                                    ...
                                    <a href="#" class="text-reset notification-item">
                                        <div class="d-flex border-bottom align-items-start">
                                            <div class="flex-shrink-0">
                                                <img src="<?=ASSETS_URL4?>images/users/avatar-3.jpg"
                                    ...
                                    <a href="#" class="text-reset notification-item">
                                        <div class="d-flex border-bottom align-items-start">
                                            <div class="flex-shrink-0">
                                                <img src="<?=ASSETS_URL4?>images/users/avatar-4.jpg"
                                                    class="me-3 rounded-circle avatar-sm" alt="user-pic">
                                            </div>
                                            <div class="flex-grow-1">
                            ...
                            <div class="col-xl-4">
                                <div class="card">
                                    <div class="card-header justify-content-between d-flex align-items-center">
                                        ...
                                        <a href="https://getbootstrap.com/docs/5.3/components/alerts/#examples" target="_blank" class="btn btn-sm btn-secondary-subtle">Docs <i class="mdi mdi-arrow-right align-middle"></i></a>
                                    </div><!-- end card header -->
                            ...
                            <div class="col-xl-4">
                                <div class="card">
                                    <div class="card-header justify-content-between d-flex align-items-center">
                                        ...
                                        <a href="https://getbootstrap.com/docs/5.3/components/alerts/#icons" target="_blank" class="btn btn-sm btn-secondary-subtle">Docs <i class="mdi mdi-arrow-right align-middle"></i></a>
                                    </div><!-- end card header -->
                            ...
                            <div class="col-xl-4">
                                <div class="card">
                                    <div class="card-header justify-content-between d-flex align-items-center">
                                        ...
                                        <a href="https://getbootstrap.com/docs/5.3/components/alerts/#dismissing" target="_blank" class="btn btn-sm btn-secondary-subtle">Docs <i class="mdi mdi-arrow-right align-middle"></i></a>
                                    </div><!-- end card header -->
                            ...
                            <div class="col-xl-4">
                                <div class="card card-h-100">
                                    <div class="card-header justify-content-between d-flex align-items-center">
                                        ...
                                        <a href="https://getbootstrap.com/docs/5.3/components/alerts/#link-color" target="_blank" class="btn btn-sm btn-secondary-subtle">Docs <i class="mdi mdi-arrow-right align-middle"></i></a>
                                    </div><!-- end card header -->
                            ...
                            <div class="col-xl-4">
                                <div class="card card-h-100">
                                    <div class="card-header justify-content-between d-flex align-items-center">
                                        ...
                                        <p class="m-0 badge badge-primary-subtle py-2">Dashonic Only</p>
                                    </div><!-- end card header -->
                                    ...
                                    <div class="card-body">
                                        <div class="">
                                            ...
                                            <div class="alert alert-dark alert-top-border alert-dismissible fade show mb-0" role="alert">
                                                <i class="uil uil-location-arrow-alt font-size-16 text-body me-2"></i>
