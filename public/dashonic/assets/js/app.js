var asset_url = 'http://localhost/codeigniter46/public/dashonic/assets/';
...
! function() {
	...
	function n(e) {
		document.getElementById("header-lang-img") && ("en" == e ? document.getElementById("header-lang-img").src = asset_url+"images/flags/us.jpg" : "sp" == e ? document.getElementById("header-lang-img").src = asset_url+"images/flags/spain.jpg" : "gr" == e ? document.getElementById("header-lang-img").src = asset_url+"images/flags/germany.jpg" : "it" == e ? document.getElementById("header-lang-img").src = asset_url+"images/flags/italy.jpg" : "ru" == e && (document.getElementById("header-lang-img").src = asset_url+"images/flags/russia.jpg"), localStorage.setItem("language", e), null == (t = localStorage.getItem("language")) && n(a), (e = new XMLHttpRequest).open("GET", asset_url+"lang/" + t + ".json"), e.onreadystatechange = function() {
			var a;
	...
	function r() {
		var e, t;
		feather.replace(), window.sessionStorage && ((e = sessionStorage.getItem("is_visited")) ? null !== (t = document.querySelector("#" + e)) && (t.checked = !0, t = e, 1 == document.getElementById("layout-direction-ltr").checked && "layout-direction-ltr" === t ? (document.getElementsByTagName("html")[0].removeAttribute("dir"), document.getElementById("layout-direction-rtl").checked = !1, document.getElementById("bootstrap-style").setAttribute("href", asset_url+"css/bootstrap.min.css"), document.getElementById("app-style").setAttribute("href", asset_url+"css/app.min.css"), sessionStorage.setItem("is_visited", "layout-direction-ltr")) : 1 == document.getElementById("layout-direction-rtl").checked && "layout-direction-rtl" === t && (document.getElementById("layout-direction-ltr").checked = !1, document.getElementById("bootstrap-style").setAttribute("href", asset_url+"css/bootstrap-rtl.min.css"), document.getElementById("app-style").setAttribute("href", asset_url+"css/app-rtl.min.css"), document.getElementsByTagName("html")[0].setAttribute("dir", "rtl"), sessionStorage.setItem("is_visited", "layout-direction-rtl"))) : sessionStorage.setItem("is_visited", "layout-direction-ltr"))
	}
	...
	}, r(), document.addEventListener("DOMContentLoaded", function(e) {
	...
	}), n(null === t ? a : t), (u = document.getElementsByClassName("language")) && Array.from(u).forEach(function(t) {
